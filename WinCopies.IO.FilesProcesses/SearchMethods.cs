...
namespace WinCopies.IO.FileProcesses
{
    ...
    public static class SearchMethods 
    {
        ...
        public static bool AddFile(System.IO.FileSystemInfo path, FileTypes fileType, ActionType ActionType, bool LoadOnlyItemsWithSearchTermsForAllActions, Search_Terms_Properties Search_Terms)
        {
            ...
            else if (fileType == FileTypes.Folder || fileType == FileTypes.Drive)
