namespace SevenZip
{
    ...
    public abstract class SevenZipBase : MarshalByRefObject
    {
        ...
        public static readonly AsyncCallback AsyncCallbackImplementation = AsyncCallbackMethod;
        ...
        public void OnEvent<T>(EventHandler<T> handler, T e, bool synchronous) where T : EventArgs
        {
            try
            {
                if (handler != null)
        ...
        ~SevenZipBase()
        {
            ...
            lock (Identificators)
                ...
                Identificators.Remove(UniqueID);
        }
        ...
        public void CheckedExecute(int hresult, string message, CallbackBase handler)
        {
                        ...
                        switch (hresult)
                        {
                            ...
                            default:
                                exception = new SevenZipException(
                                    $"Execution has failed due to an public SevenZipSharp issue (0x{hresult:x}).\n" +
        ...
        {
            if (!(obj is SevenZipBase inst))

                return false;

            return UniqueID == inst.UniqueID;
        }
        ...
        public override string ToString()
        {
            ...
            return string.Format("{0} [{1}]", type, UniqueID);
        }
    }
    ...
    {
        public ReadOnlyCollection<ArchiveProperty> _archiveFileInfoProperties;

        public ReadOnlyCollection<ArchiveProperty> ArchiveFileInfoProperties => _archiveFileInfoProperties;
    ...
    public enum InternalCompressionMode
    {
        /// <summary>
        /// Create a new archive; overwrite the existing one.
        /// </summary>
