namespace SevenZip
{
    ...
    /// </summary>
    public sealed class ArchiveOpenCallback : CallbackBase, IArchiveOpenCallback, IArchiveOpenVolumeCallback,
                                                ICryptoGetTextPassword, IDisposable
    {
        ...
        public ArchiveOpenCallback(string fileName) => Init(fileName);
        ...
        public ArchiveOpenCallback(string fileName, string password) : base(password) => Init(fileName);
