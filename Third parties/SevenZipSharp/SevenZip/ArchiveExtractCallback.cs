namespace SevenZip
{
    ...
    /// </summary>
    public sealed class ArchiveExtractCallback : CallbackBase, IArchiveExtractCallback, ICryptoGetTextPassword,
                                                   IDisposable
    {
        ...
        public ArchiveExtractCallback(IInArchive archive, string directory, int filesCount, bool directoryStructure,
            List<uint> actualIndexes, SevenZipExtractor extractor) => Init(archive, directory, filesCount, directoryStructure, actualIndexes, extractor);
        ...
        public ArchiveExtractCallback(IInArchive archive, string directory, int filesCount, bool directoryStructure,
            ...
            : base(password) => Init(archive, directory, filesCount, directoryStructure, actualIndexes, extractor);
        ...
        public ArchiveExtractCallback(IInArchive archive, Stream stream, int filesCount, uint fileIndex,
                                      SevenZipExtractor extractor) => Init(archive, stream, filesCount, fileIndex, extractor);
        ...
        public ArchiveExtractCallback(IInArchive archive, Stream stream, int filesCount, uint fileIndex, string password,
            ...
            : base(password) => Init(archive, stream, filesCount, fileIndex, extractor);
        ...
        private void OnFileExists(FileOverwriteEventArgs e) => FileExists?.Invoke(this, e);

        private void OnOpen(OpenEventArgs e) => Open?.Invoke(this, e);

        private void OnFileExtractionStarted(FileInfoEventArgs e) => FileExtractionStarted?.Invoke(this, e);

        private void OnFileExtractionFinished(FileInfoEventArgs e) => FileExtractionFinished?.Invoke(this, e);

        private void OnExtracting(ProgressEventArgs e) => Extracting?.Invoke(this, e);
