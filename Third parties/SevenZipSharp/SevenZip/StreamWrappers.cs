namespace SevenZip
{
    ...
    public class StreamWrapper : DisposeVariableWrapper, IDisposable
    {
        ...
        protected StreamWrapper(Stream baseStream, bool disposeStream)
            : base(disposeStream) => BaseStream = baseStream;
        ...
        public void Dispose()
        {
            if (BaseStream != null && DisposeStream)
            {               
                try
                {
                    BaseStream.Dispose();
    ...
    /// </summary>
    public sealed class InStreamWrapper : StreamWrapper, ISequentialInStream, IInStream
    {
        /// <summary>
    ...
    /// </summary>
    public class MultiStreamWrapper : DisposeVariableWrapper, IDisposable
    {
    ...
    /// </summary>
    public sealed class InMultiStreamWrapper : MultiStreamWrapper, ISequentialInStream, IInStream
    {
        /// <summary>
    ...
    /// </summary>
    public sealed class OutMultiStreamWrapper : MultiStreamWrapper, ISequentialOutStream, IOutStream
    {
    ...
    public sealed class FakeOutStreamWrapper : ISequentialOutStream, IDisposable
    {
        #region IDisposable Members
