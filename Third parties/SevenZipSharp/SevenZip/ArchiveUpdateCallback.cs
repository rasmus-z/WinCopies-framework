namespace SevenZip
{
    ...
    /// </summary>
    public sealed class ArchiveUpdateCallback : CallbackBase, IArchiveUpdateCallback, ICryptoGetTextPassword2,
                                                  IDisposable
    {
        #region Fields
        /// <summary>
        ...
        public ArchiveUpdateCallback(
            ...
            SevenZipCompressor compressor, UpdateData updateData, bool directoryStructure) => Init(files, rootLength, compressor, updateData, directoryStructure);
        ...
        public ArchiveUpdateCallback(
            ...
            : base(password) => Init(files, rootLength, compressor, updateData, directoryStructure);
        ...
        /// <param name="directoryStructure">Preserve directory structure.</param>
        public ArchiveUpdateCallback(
            Stream stream, SevenZipCompressor compressor, UpdateData updateData, bool directoryStructure) => Init(stream, compressor, updateData, directoryStructure);
        ...
        public ArchiveUpdateCallback(
            ...
            : base(password) => Init(stream, compressor, updateData, directoryStructure);
        ...
        public ArchiveUpdateCallback(
            ...
            SevenZipCompressor compressor, UpdateData updateData, bool directoryStructure) => Init(streamDict, compressor, updateData, directoryStructure);
        ...
        public ArchiveUpdateCallback(
            ...
            SevenZipCompressor compressor, UpdateData updateData, bool directoryStructure)
            : base(password) => Init(streamDict, compressor, updateData, directoryStructure);
            ...
            switch (_updateData.Mode)
            {
                ...
                case InternalCompressionMode.Modify:
                        ...
                        && _updateData.FileNamesToModify[(int)index] == null)
                    {
                        ...
                        foreach (KeyValuePair<int, string> pairModification in _updateData.FileNamesToModify)
                            if ((pairModification.Key <= index) && (pairModification.Value == null))
                            {
                                ...
                                while ((indexInArchive > 0) && _updateData.FileNamesToModify.ContainsKey((int)indexInArchive)
