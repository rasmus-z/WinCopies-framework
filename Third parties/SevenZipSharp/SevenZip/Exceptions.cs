namespace SevenZip
{
    ...
    public class SevenZipException : Exception
    {
        ...
        /// </summary>
        public const string USER_EXCEPTION_MESSAGE = "The extraction was successful but" +
    ...
    public class SevenZipLibraryException : SevenZipException
    {
        ...
        /// Exception dafault message which is displayed if no extra information is specified
        /// </summary>
        public const string DEFAULT_MESSAGE = "Can not load 7-zip library or public COM error!";
