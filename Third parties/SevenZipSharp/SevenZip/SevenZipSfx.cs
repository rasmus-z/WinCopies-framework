namespace SevenZip
{
    ...
    public class SevenZipSfx
    {
        ...
        /// </summary>
        public SfxModule SfxModule { get; private set; } = SfxModule.Default;
        ...
        private void ValidateSettings(SfxSettings settings)
        {
            ...
            List<string> commands = _sfxCommands[SfxModule];
        ...
        public void MakeSfx(Stream archive, string sfxFileName) => MakeSfx(archive, GetDefaultSettings(), File.Create(sfxFileName));
        ...
        /// <param name="sfxFileName">The name of the self-extracting executable.</param>
        public void MakeSfx(Stream archive, SfxSettings settings, string sfxFileName) => MakeSfx(archive, settings, File.Create(sfxFileName));
        ...
        /// <param name="archiveFileName">The archive file name.</param>
        /// <param name="sfxStream">The stream to write the self-extracting executable to.</param>
        public void MakeSfx(string archiveFileName, Stream sfxStream) => MakeSfx(new FileStream(archiveFileName, FileMode.Open, FileAccess.Read, FileShare.ReadWrite), GetDefaultSettings(), sfxStream);
        ...
        /// <param name="settings">The sfx settings.</param>
        /// <param name="sfxStream">The stream to write the self-extracting executable to.</param>
        public void MakeSfx(string archiveFileName, SfxSettings settings, Stream sfxStream) => MakeSfx(new FileStream(archiveFileName, FileMode.Open, FileAccess.Read, FileShare.ReadWrite), settings, sfxStream);
