...
namespace WinCopies.GUI.Windows.Dialogs
{
    public class FoldersBrowserDialogCommandButtonContentConverter : Util.DataConverters.MultiConverterBase
    {
        public override object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (selectedItem != null && (selectedItem.FileType == FileTypes.Folder || (selectedItem.FileType == FileTypes.SpecialFolder && selectedItem is ShellObjectInfo so && so.ShellObject.IsFileSystemObject) || selectedItem.FileType == FileTypes.Drive))
