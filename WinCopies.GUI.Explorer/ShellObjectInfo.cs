...
namespace WinCopies.GUI.Explorer
{
    ...
    public class ShellObjectInfo : IO.ShellObjectInfo, IBrowsableObjectInfo, IBrowsableObjectInfoInternal
    {
...

        {
            ...
            get => isSelected; set => OnPropertyChanged(nameof(IsSelected), nameof(isSelected), value, typeof(ShellObjectInfo));

        }

        private IBrowsableObjectInfo selectedItem = null;

        public IBrowsableObjectInfo SelectedItem

        {

            get => selectedItem;

            set => OnPropertyChanged(nameof(SelectedItem), nameof(selectedItem), value, typeof(ShellObjectInfo));
