...
{
    public sealed class JoinSubEnumerator : _Enumerator
    {
        private IEnumerator _joinEnumerator;
        private object _firstValue;
        private bool _completed = false;
        private Func<bool> _moveNext;

        public JoinSubEnumerator(IEnumerable subEnumerable, IEnumerable joinEnumerable) : base(subEnumerable)
        {
#if DEBUG
    ...
    public sealed class JoinEnumerator : WinCopies.Collections.Generic.Enumerator<IEnumerable, object>
    {
        private IEnumerator _subEnumerator;
        private IEnumerable _joinEnumerable;
        private bool _completed = false;
        private Action _updateEnumerator;
        private Func<bool> _moveNext;
        private readonly bool _keepEmptyEnumerables;

        public JoinEnumerator(IEnumerable<IEnumerable> enumerable, bool keepEmptyEnumerables, params object[] join) : base(enumerable)
        {
        ...
        private void InitDelegates()
        {
            _updateEnumerator = () =>
            {
                ...
                if (_keepEmptyEnumerables)
                    ...
                    _updateEnumerator = () => _subEnumerator = new JoinSubEnumerator(InnerEnumerator.Current, _joinEnumerable);
            };
