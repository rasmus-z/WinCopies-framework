...
// todo: to complete doc

namespace WinCopies.Win32Interop
{
    public static class SystemMetricUtil
    {

        /// <summary>
        /// Retrieves various system metrics of display elements and system configuration settings. See the Remarks section.
        /// </summary>
        /// <param name="smIndex">System metric or configuration setting to retrieve. This parameter can be one of the <see cref="SystemMetric"/> values. Note that all SM_CX* values are widths and all SM_CY* values are heights. Also note that all settings designed to return Boolean data represent TRUE as any nonzero value, and FALSE as a zero value.</param>
        /// <remarks><para>System metrics may vary from display to display. Most values are returned in number of pixels, all others are flag or boolean values.</para>
        /// <para>GetSystemMetrics(SM_CMONITORS) counts only display monitors.This is different from EnumDisplayMonitors, which enumerates display monitors and also non-display pseudo-monitors.</para>
        /// <para>The <see cref="SystemMetric.SM_ARRANGE"/> setting specifies how the system arranges minimized windows, and consists of a starting position and a direction. The starting position can be one of the following values.
        /// | Value           | Meaning                                                                                    |
        ...
        /// <para>The direction in which to arrange can be one of the following values.</para>
        /// | Value     | Meaning                              |
        ...
        /// | ARW_UP    | Arrange vertically, bottom to top.</para></remarks>
        /// <returns></returns>
        ...
        public enum SystemMetric : int
        {
            ...
            /// <summary>
            /// This value is the same as <see cref="SM_CXFIXEDFRAME"/>.
            /// </summary>
            SM_CXDLGFRAME = 7,

            /// <summary>
            /// The thickness of the frame around the perimeter of a window that has a caption but is not sizable, in pixels.
            /// <see cref="SM_CXFIXEDFRAME"/> is the height of the horizontal border, and <see cref="SM_CYFIXEDFRAME"/> is the width of the vertical border.
            /// This value is the same as <see cref="SM_CXDLGFRAME"/>.
            /// </summary>
            SM_CXFIXEDFRAME = 7,

            /// <summary>
            /// This value is the same as <see cref="SM_CYFIXEDFRAME"/>.
            /// </summary>
            SM_CYDLGFRAME = 8,
            ...
            /// <summary>
            /// The default height of an icon, in pixels. The LoadIcon function can load only icons with the dimensions <see cref="SM_CXICON"/> and <see cref="SM_CYICON"/>.
            /// </summary>
            SM_CYICON = 12,
            ...
            /// The second click must occur within the rectangle that is defined by <see cref="SM_CXDOUBLECLK">/</see> and <see cref="SM_CYDOUBLECLK"/> for the system
