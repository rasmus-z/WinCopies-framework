...
namespace WinCopies.Collections
{
    ...
    public class ReadOnlyObservableTreeNode<TValue, TItems> : TreeNode<TValue, TItems>, System.Collections.Specialized.INotifyCollectionChanged, INotifyPropertyChanged
    {
