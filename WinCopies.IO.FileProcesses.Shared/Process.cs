...
namespace WinCopies.IO.FileProcesses
{
    ...
    public abstract class Process : IBackgroundWorker, INotifyPropertyChanged
    {
        ...
        private readonly int _startItemIndex = 0;
        ...
        private readonly FilesInfoLoader _FilesInfoLoader = null;
        ...
        private readonly bool _exceptionsOccurred = false;
        ...
        private readonly bool _pausePending = false;
        ...
        private readonly FileSystemInfo _pausedFile = null;
        ...
        private readonly int _pausedIndex = -1;
        ...
        private readonly bool _stopProcessOnPause = true;
