...
namespace WinCopies.IO
{
    ...
    public static class Registry
    {
...

        {
            ...
            if (If(ComparisonType.Or, Comparison.Equals, out key, /*EqualityComparer<object>.Default, GetCommonPredicate<object>(),*/ null, GetKeyValuePair(nameof(commandName), (object)commandName), GetKeyValuePair(nameof(extension), (object)extension)))

                throw new ArgumentNullException(key);

            if (If(ComparisonType.Or, Comparison.Equals, out key, true, GetKeyValuePair(nameof(commandName), IsNullEmptyOrWhiteSpace(commandName)), GetKeyValuePair(nameof(extension), IsNullEmptyOrWhiteSpace(extension))))
...

        {
            ...
            if (If(ComparisonType.Or, Comparison.Equals, out key, null, GetKeyValuePair(nameof(commandName), commandName), GetKeyValuePair(nameof(commandName), fileType)))

                throw new ArgumentNullException(key);

            if (If(ComparisonType.Or, Comparison.Equals, out key, true, GetKeyValuePair(nameof(commandName), IsNullEmptyOrWhiteSpace(commandName)), GetKeyValuePair(nameof(fileType), IsNullEmptyOrWhiteSpace(fileType))))
...

        {
            ...
            if (If(ComparisonType.Or, Comparison.Equals, out key, null, GetKeyValuePair(nameof(command), command), GetKeyValuePair(nameof(fileName), fileName)))

                throw new ArgumentNullException(key);

            if (If(ComparisonType.Or, Comparison.Equals, out key, true, GetKeyValuePair(nameof(command), IsNullEmptyOrWhiteSpace(command)), GetKeyValuePair(nameof(fileName), IsNullEmptyOrWhiteSpace(fileName))))
...

        {
            ...
            if (If(ComparisonType.Or, Comparison.Equals, out key, null, GetKeyValuePair(nameof(fileType), (object)fileType), GetKeyValuePair(nameof(registryKey), (object)registryKey)))
            ...
            if (If(ComparisonType.Or, Comparison.Equals, registryKey.Name, "HKEY_CURRENT_USER\\Software\\Classes", "HKEY_CURRENT_USER\\Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\FileExts", "HKEY_CLASSES_ROOT", "HKEY_LOCAL_MACHINE\\SOFTWARE\\Classes"))
...

        {
            ...
            if (If(ComparisonType.Or, Comparison.Equals, out registryKey, registryKeyName, GetKeyValuePair(Microsoft.Win32.Registry.ClassesRoot, Microsoft.Win32.Registry.ClassesRoot.Name),
