...
namespace WinCopies.IO
{
    ...
    public interface IWMIItemInfoFactory : IBrowsableObjectInfoFactory
    {
        ...
        IBrowsableObjectInfo GetBrowsableObjectInfo(string path, WMIItemType wmiItemType, DeepClone<ManagementBaseObject> managementObjectDelegate, ManagementBaseObject managementObject);

        IBrowsableObjectInfo GetBrowsableObjectInfo(string path, WMIItemType wmiItemType, DeepClone<ManagementBaseObject> managementObjectDelegate, ManagementBaseObject managementObject, IWMIItemInfoFactory factory);
