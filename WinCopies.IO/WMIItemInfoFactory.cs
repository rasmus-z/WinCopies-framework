...
namespace WinCopies.IO
{
    ...
    public class WMIItemInfoFactory<TParent, TItems> : BrowsableObjectInfoFactory, IWMIItemInfoFactory where TParent : class, IWMIItemInfo where TItems : class, IWMIItemInfo
    {
        ...
        public virtual IBrowsableObjectInfo GetBrowsableObjectInfo(string path, WMIItemType wmiItemType, DeepClone<ManagementBaseObject> managementObjectDelegate, ManagementBaseObject managementObject) => GetBrowsableObjectInfo(path, wmiItemType, managementObjectDelegate, managementObject, UseRecursively ? (WMIItemInfoFactory<TParent, TItems>)DeepClone() : null);
        ...
        public virtual IBrowsableObjectInfo GetBrowsableObjectInfo(string path, WMIItemType wmiItemType, DeepClone<ManagementBaseObject> managementObjectDelegate, ManagementBaseObject managementObject, IWMIItemInfoFactory factory) => new WMIItemInfo<TParent, TItems, IWMIItemInfoFactory>(path, wmiItemType, managementObjectDelegate, managementObject, factory);

        public virtual IBrowsableObjectInfo GetBrowsableObjectInfo(string path, WMIItemType wmiItemType, IWMIItemInfoFactory factory)
        {

            var managementObject = new ManagementObject(new ManagementScope(path, _options?.ConnectionOptions is null ? null : WMIItemInfo.DefaultConnectionOptionsDeepClone(_options?.ConnectionOptions, null)), new ManagementPath(path), _options?.ObjectGetOptions is null ? null : WMIItemInfo.DefaultObjectGetOptionsDeepClone(_options?.ObjectGetOptions));

            return GetBrowsableObjectInfo(path, wmiItemType, _managementObject => _managementObject is ManagementClass managementClass ?    WMIItemInfo.DefaultManagementClassDeepCloneDelegate(managementClass, null) : _managementObject is ManagementObject __managementObject ?        WMIItemInfo.DefaultManagementObjectDeepClone(__managementObject, null) : throw new ArgumentException("The given object must be a ManagementClass or a ManagementObject.", "managementObject") , managementObject, factory);
